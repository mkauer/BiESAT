...
Double_t f_landau_976(Double_t *xval, Double_t *par)
{
  ...
  gaus976 = Gn976*(7.03*TMath::Gaus(x,Ge976,Gs976) + 1.84*TMath::Gaus(x,Ge976+72.3*Gc976,Gs976*TMath::Sqrt(1+73*Gc976/Ge976)) + 0.545*TMath::Gaus(x,Ge976+84.3*Gc976,Gs976*TMath::Sqrt(1+85*Gc976/Ge976)));
  land976 = Ln976*(TMath::Landau((2*mpv976)-x,mpv976,Ls976));
  
  return gaus976+land976+offset;
}
